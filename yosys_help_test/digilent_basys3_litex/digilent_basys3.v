...
assign builder_shared_err = ((main_basesoc_basesoc_ram_bus_err | main_basesoc_ram_bus_ram_bus_err) | builder_basesoc_wishbone_err);
assign builder_wait = ((builder_shared_stb & builder_shared_cyc) & (~builder_shared_ack));
always @(*) begin
	builder_shared_ack <= 1'd0;
	builder_shared_dat_r <= 32'd0;
	builder_error <= 1'd0;
	builder_shared_ack <= ((main_basesoc_basesoc_ram_bus_ack | main_basesoc_ram_bus_ram_bus_ack) | builder_basesoc_wishbone_ack);
	builder_shared_dat_r <= ((({32{builder_slave_sel_r[0]}} & main_basesoc_basesoc_ram_bus_dat_r) | ({32{builder_slave_sel_r[1]}} & main_basesoc_ram_bus_ram_bus_dat_r)) | ({32{builder_slave_sel_r[2]}} & builder_basesoc_wishbone_dat_r));
...
//------------------------------------------------------------------------------
// Memory rom: 5909-words x 32-bit
//------------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-08-17 14:01:52.
//------------------------------------------------------------------------------
